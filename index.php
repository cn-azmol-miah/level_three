...
<div class="position-relative overflow-hidden p-5 bg-light">
    <div class="row" style="height: 50vh;">
        <div class="col-md-6 animate__animated animate__fadeInLeft">
            <h1 class="display-4 fw-normal">Codenation shop</h1>
            ...
            <a class="btn btn-outline-primary mt-5" href="docs.php" target="_blank"> <i class="fas fa-file-alt align-self-center"></i>
                Documentation</a>
        </div>
        <div class="col-md-6">
