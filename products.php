...
// Get flag for table drop
$flag_six_query = "SELECT * FROM flags WHERE id = 6";
$flag_six_result = mysqli_query($conn, $flag_six_query);
$flag_six = mysqli_fetch_assoc($flag_six_result);
?>
